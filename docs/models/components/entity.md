...
| `instructionSchemaVersion`                                                                    | *number*                                                                                      | :heavy_minus_sign:                                                                            | Instruction entity schema version used to generate this entity.                               |
| `instructionSchemaShapeFingerprint`                                                           | *string*                                                                                      | :heavy_minus_sign:                                                                            | Shape-only fingerprint of the instruction entity schema used to generate this entity.         |