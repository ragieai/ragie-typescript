 ...
 */
export function partitionsCreate(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CreatePartitionParams$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "create_partition_partitions_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Partition$inboundSchema),
