 ...
 */
export function entitiesListExtractionLogs(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInstructionEntityExtractionLogsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/instructions/{instruction_id}/entity-extraction-logs",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "ListInstructionEntityExtractionLogs",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListInstructionEntityExtractionLogsResponse$inboundSchema,
      { key: "Result" },
    ),
