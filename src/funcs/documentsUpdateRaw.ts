 ...
 * Update Document Raw
 */
export async function documentsUpdateRaw(
  client: RagieCore,
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateDocumentRawParams, {
    explode: true,
  });
  ...
  const path = pathToFunc("/documents/{document_id}/raw")(pathParams);
