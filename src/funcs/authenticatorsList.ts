...
export function authenticatorsList(
  ...
  PageIterator<
    Result<
      operations.ListAuthenticatorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAuthenticatorsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAuthenticatorsResponse$inboundSchema, {
      key: "Result",
    }),
