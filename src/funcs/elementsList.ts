...
export function elementsList(
  ...
  Result<
    components.ListDocumentElements,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListElementsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/documents/{document_id}/elements")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListDocumentElements$inboundSchema),
