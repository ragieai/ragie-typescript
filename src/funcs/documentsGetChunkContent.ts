 ...
 */
export function documentsGetChunkContent(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDocumentChunkContentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/documents/{document_id}/chunks/{chunk_id}/content")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "GetDocumentChunkContent",
    oAuth2Scopes: null,
