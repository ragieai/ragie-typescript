 ...
 */
export function partitionsDisableMcp(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisableMcpPartitionsPartitionIdMcpDeleteRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/partitions/{partition_id}/mcp")(pathParams);
  ...
  const context = {
    ...
    operationID: "disable_mcp_partitions__partition_id__mcp_delete",
    oAuth2Scopes: [],
