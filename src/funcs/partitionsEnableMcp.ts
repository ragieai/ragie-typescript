 ...
 */
export function partitionsEnableMcp(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EnableMcpPartitionsPartitionIdMcpPostRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "enable_mcp_partitions__partition_id__mcp_post",
    oAuth2Scopes: [],
