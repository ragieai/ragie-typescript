 ...
 */
export async function documentsPatchMetadata(
  client: RagieCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchDocumentMetadataRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PatchDocumentMetadataParams, {
    explode: true,
  });
  ...
  const path = pathToFunc("/documents/{document_id}/metadata")(pathParams);
