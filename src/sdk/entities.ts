...
export class Entities extends ClientSDK {
    ...
    async listInstructions(options?: RequestOptions): Promise<Array<components.Instruction>> {
        return unwrapAsync(entitiesListInstructions(this, options));
    }
    ...
    async createInstruction(
        ...
        return unwrapAsync(entitiesCreateInstruction(this, request, options));
    }
    ...
    async updateInstruction(
        ...
        return unwrapAsync(entitiesUpdateInstruction(this, request, options));
    }
    ...
    async listByInstruction(
        ...
        return unwrapResultIterator(entitiesListByInstruction(this, request, options));
    }
