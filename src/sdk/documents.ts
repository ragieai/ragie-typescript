...
export class Documents extends ClientSDK {
    ...
    async create(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => components.BodyCreateDocument$outboundSchema.parse(value$),
            "Input validation failed"
        );
    ...
    async createRaw(
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => components.DocumentCreateRaw$outboundSchema.parse(value$),
            "Input validation failed"
        );
    ...
    async updateFile(
        ...
        if (isBlobLike(payload$.Body_UpdateDocumentFile.file)) {
            body$.append("file", payload$.Body_UpdateDocumentFile.file);
        } else {
            body$.append(
                "file",
                new Blob([payload$.Body_UpdateDocumentFile.file.content], {
                    type: "application/octet-stream",
                }),
                payload$.Body_UpdateDocumentFile.file.fileName
            );
        }
        if (payload$.Body_UpdateDocumentFile.mode !== undefined) {
            body$.append("mode", payload$.Body_UpdateDocumentFile.mode);
        }
