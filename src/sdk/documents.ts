...
export class Documents extends ClientSDK {
    ...
    async list(
        ...
        return unwrapResultIterator(documentsList(this, request, options));
    }
    ...
    async create(
        ...
        return unwrapAsync(documentsCreate(this, request, options));
    }
    ...
    async createRaw(
        ...
        return unwrapAsync(documentsCreateRaw(this, request, options));
    }
    ...
    async createDocumentFromUrl(
        ...
        return unwrapAsync(documentsCreateDocumentFromUrl(this, request, options));
    }
    ...
    async get(
        ...
        return unwrapAsync(documentsGet(this, request, options));
    }
    ...
    async delete(
        ...
        return unwrapAsync(documentsDelete(this, request, options));
    }
    ...
    async updateFile(
        ...
        return unwrapAsync(documentsUpdateFile(this, request, options));
    }
    ...
    async updateRaw(
        ...
        return unwrapAsync(documentsUpdateRaw(this, request, options));
    }
    ...
    async patchMetadata(
        ...
        return unwrapAsync(documentsPatchMetadata(this, request, options));
    }
