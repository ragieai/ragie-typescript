...
import { connectionsCreateOauthRedirectUrlConnectionsOauthPost } from "../funcs/connectionsCreateOauthRedirectUrlConnectionsOauthPost.js";
...
export class Connections extends ClientSDK {
   ...
   */
  async createOauthRedirectUrlConnectionsOauthPost(
    request: components.OAuthUrlCreate,
    options?: RequestOptions,
  ): Promise<components.OAuthUrlResponse> {
    return unwrapAsync(connectionsCreateOauthRedirectUrlConnectionsOauthPost(
      this,
      request,
      options,
    ));
