...
export type CreateDocumentRawParamsMetadata = string | number | boolean | Array<string>;
...
/** @internal */
export type CreateDocumentRawParamsMetadata$Outbound = string | number | boolean | Array<string>;
