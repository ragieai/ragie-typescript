 ...
 * The scope of the instruction. Determines whether the instruction is applied to the entire document or to each chunk of the document. Options are `'document'` or `'chunk'`. Generally `'document'` should be used when analyzing the full document is desired, such as when generating a summary or determining sentiment, and `'chunk'` should be used when a fine grained search over a document is desired.
 */
export type InstructionScope = ClosedEnum<typeof InstructionScope>;
 ...
 */
export type InstructionEntitySchema = {};
...
export type Instruction = {
     ...
     * The scope of the instruction. Determines whether the instruction is applied to the entire document or to each chunk of the document. Options are `'document'` or `'chunk'`. Generally `'document'` should be used when analyzing the full document is desired, such as when generating a summary or determining sentiment, and `'chunk'` should be used when a fine grained search over a document is desired.
     */
    scope?: InstructionScope | undefined;
    /**
     ...
     * The JSON schema definition of the entity generated by an instruction. The schema must define an `object` at its root. If the instruction is expected to generate multiple items, the root object should have a key which defines an array of the expected items. An instruction which generates multiple emails may be expressed as `{"type": "object", "properties": {"emails": { "type": "array", "items": { "type": "string"}}}}`. Simple values may be expressed as an object with a single key. For example, a summary instruction may generate a single string value. The schema might be `{"type": "object", "properties": { "summary": { "type": "string"}}}`.
     */
    entitySchema: InstructionEntitySchema;
};

/** @internal */
export const InstructionScope$inboundSchema: z.ZodNativeEnum<typeof InstructionScope> =
    z.nativeEnum(InstructionScope);

/** @internal */
export const InstructionScope$outboundSchema: z.ZodNativeEnum<typeof InstructionScope> =
    InstructionScope$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace InstructionScope$ {
    /** @deprecated use `InstructionScope$inboundSchema` instead. */
    export const inboundSchema = InstructionScope$inboundSchema;
    /** @deprecated use `InstructionScope$outboundSchema` instead. */
    export const outboundSchema = InstructionScope$outboundSchema;
}

/** @internal */
export const InstructionEntitySchema$inboundSchema: z.ZodType<
...
/** @internal */
export type InstructionEntitySchema$Outbound = {};

/** @internal */
export const InstructionEntitySchema$outboundSchema: z.ZodType<
    InstructionEntitySchema$Outbound,
    z.ZodTypeDef,
    InstructionEntitySchema
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace InstructionEntitySchema$ {
    /** @deprecated use `InstructionEntitySchema$inboundSchema` instead. */
    export const inboundSchema = InstructionEntitySchema$inboundSchema;
    /** @deprecated use `InstructionEntitySchema$outboundSchema` instead. */
    export const outboundSchema = InstructionEntitySchema$outboundSchema;
    /** @deprecated use `InstructionEntitySchema$Outbound` instead. */
    export type Outbound = InstructionEntitySchema$Outbound;
}
...
export const Instruction$inboundSchema: z.ZodType<Instruction, z.ZodTypeDef, unknown> = z
    .object({
        ...
        scope: InstructionScope$inboundSchema.default("chunk"),
        prompt: z.string(),
        entity_schema: z.lazy(() => InstructionEntitySchema$inboundSchema),
    })
    .transform((v) => {
        return remap$(v, {
...
export type Instruction$Outbound = {
    ...
    scope: string;
    prompt: string;
    entity_schema: InstructionEntitySchema$Outbound;
};
...
> = z
    .object({
        ...
        name: z.string(),
        active: z.boolean().default(true),
        scope: InstructionScope$outboundSchema.default("chunk"),
        prompt: z.string(),
        entitySchema: z.lazy(() => InstructionEntitySchema$outboundSchema),
    })
    .transform((v) => {
        return remap$(v, {
