...
export type ListEntitiesByInstructionResponse = {
    result: components.EntityListResponse;
};
...
> = z
    .object({
        Result: components.EntityListResponse$inboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
            Result: "result",
...
export type ListEntitiesByInstructionResponse$Outbound = {
    Result: components.EntityListResponse$Outbound;
};
...
> = z
    .object({
        result: components.EntityListResponse$outboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
            result: "Result",
...
export namespace ListEntitiesByInstructionResponse$ {
    ...
    export const outboundSchema = ListEntitiesByInstructionResponse$outboundSchema;
